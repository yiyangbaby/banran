 ...
 * ============================================================================
 * @version:    v6.0 r20180508
 * ---------------------------------------------
 * $Id: index.php 2018/05/08
 */
...
set_include_path(ROOT.'/lib/default'.PATH_SEPARATOR.ROOT.'/lib/admin'.PATH_SEPARATOR.ROOT.'/lib/plugins'.PATH_SEPARATOR.ROOT.'/lib/tool'.PATH_SEPARATOR.ROOT.'/lib/table'.PATH_SEPARATOR.ROOT.'/lib/inc');
