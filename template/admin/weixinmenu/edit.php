...
<form method="post" name="form1" action="<?php if(front::$act=='edit') $id="/id/".$data['id']; else $id=''; echo modify("/act/".front::$act."/table/".$table.$id);?>"  onsubmit="return checkform();">
...
<div class="row">
<div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right">类型
</div>
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<select name="typeid" id="typeid" onchange="changetype()" class="form-control select">
          {if !intval(front::$get['pid'])}
          <option value="1" {if $data['typeid']==1}selected{/if}>菜单</option>
          {/if}
          <option value="2" {if $data['typeid']==2}selected{/if}>打开网址</option>
		...
		<dl>
			...
			<dd>
				<textarea name="txt" class="textarea gens nonull" value="{$data['txt']}" onfocus="if(this.value=='请填写回复内容！') {this.value=''}" onblur="if(this.value=='') this.value='请填写回复内容！'">{$data['txt']}</textarea>
				<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="微信能够识别电话号码，支持点击电话号码直接拨打！"></span>
			</dd>
		</dl>
		</div>
		...
		<dl>
			<dt><div class="blank10"></div></dt>
			<dd>
				<input name='num' type='text'  value='{$data['num']}' class="form-control" onfocus="if(this.value=='填写推送内容条数，最多10条！') {this.value=''}" onblur="if(this.value=='') this.value='填写推送内容条数，最多10条！'" />
				<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="填写推送内容条数，最多10条！"></span>
			</dd>
		</dl>
		</div>
        <?php
		...
		<div name="imgtext" class="caidantype_4" style="display:{if $data['typeid']!=4}none{/if}">
			...
			<h3 class="v52fmbx_hr metsliding" sliding="1">图文内容[{$i}]</h3>
			<dl>
				<dt><div class="blank10"></div></dt>
...
<div class="img_upload">
			...
			<dl>
				<dt><div class="blank10"></div></dt>
				<dd style='position:relative;'>
					<input name='twname[]' type='text'  class="form-control"  value='{$tmp['0']}' class="form-control" onfocus="if(this.value=='请填写内容标题！') {this.value=''}" onblur="if(this.value=='') this.value='请填写内容标题！'" />
					<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="填写内容标题！"></span>
				</dd>
			</dl>
			<dl>
				<dt><div class="blank10"></div></dt>
				<dd style='position:relative;'>
				<input name='twurl[]' type='text' value='{$tmp['1']}'  class="text nonull input" onfocus="if(this.value=='请填写内容链接') {this.value=''}" onblur="if(this.value=='') this.value='请填写内容链接'" />
				<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="填写内容链接！"></span>
				</dd>
			</dl>
            <?php
			if($i == 1){
			...
			<dl>
				<dt><div class="blank10"></div></dt>
				<dd style='position:relative;'>
					<textarea name="intro" class="textarea"  value="{$data['intro']}" onfocus="if(this.value=='请填写描述内容') {this.value=''}" onblur="if(this.value=='') this.value='请填写描述内容'">{$data['intro']}</textarea>
					<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="多图文内容展示时候，将不会显示描述内容！"></span>
				</dd>
			</dl>
            <?php
			}
		...
		<div class="caidantype_4" style="display:{if $data['typeid']!=4}none{/if}">
			<dl>
				...
				<a href="javascript:void();" onclick="return weixin_adddisplayimg();" class="btn_b">添加图文内容</a>
		...
		<dl>
			<dt><div class="blank10"></div></dt>
			<dd>
				<input name='twurl[]' type='text' value="{$data['url']}"  class="text nonull input" onfocus="if(this.value=='请填写内容链接地址！') {this.value=''}" onblur="if(this.value=='') this.value='请填写内容链接地址！'" />
				<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="请填写内容链接地址！"></span>
			</dd>
		</dl>
		</div>
