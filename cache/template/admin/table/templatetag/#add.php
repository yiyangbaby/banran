...
<input type="hidden" name="tagfrom" value="<?php echo get('tagfrom');?>" class="form-control" />

<?php if(get('tagfrom')=='category') { ?>

<?php echo template('table/templatetag/listtag_helper_edit_cat.php'); ?>


<?php } elseif (get('tagfrom')=='content') { ?>

<?php echo template('table/templatetag/listtag_helper_edit.php'); ?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::getform('tagcontent',$form,$field,$data);?>
</div>
</div>
