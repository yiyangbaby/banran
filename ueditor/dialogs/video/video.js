...
(function(){
    ...
    function createPreviewVideo(url){
        ...
        //$G("preview").innerHTML = '<video src="'+conUrl+'"' + ' width="' + 420  + '"' + ' height="' + 280  + '"' +' controls autoplay></video>';
        $G("preview").innerHTML = '<embed src="../../third-party/ckplayer/ckplayer.swf"' +
            ' width="' + 420  + '"' +
            ' height="' + 280  + '"' +
            ' flashvars="video='+conUrl+'"'+
