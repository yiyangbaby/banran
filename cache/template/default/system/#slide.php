...
<?php if(get('slide_pic1_info')) { ?><p data-animation="animated lightSpeedIn"><?php echo get('slide_pic1_info');?></p><?php } ?>
 <?php if(get('slide_pic1_url')) { ?><a href="<?php echo get('slide_pic1_url');?>" target="_blank" class="btn btn-primary" data-animation="animated fadeInDown"><?php echo lang('more');?></a><?php } ?>
</div>
</div>
<!-- End of Slide -->
...
<?php if(get('slide_pic2_info')) { ?><p data-animation="animated lightSpeedIn"><?php echo get('slide_pic2_info');?></p><?php } ?>
 <?php if(get('slide_pic2_url')) { ?><a href="<?php echo get('slide_pic2_url');?>" target="_blank" class="btn btn-primary" data-animation="animated fadeInDown"><?php echo lang('more');?></a><?php } ?>
</div>
</div>
<!-- End of Slide -->
...
<?php if(get('slide_pic3_info')) { ?><p data-animation="animated lightSpeedIn"><?php echo get('slide_pic3_info');?></p><?php } ?>
 <?php if(get('slide_pic3_url')) { ?><a href="<?php echo get('slide_pic3_url');?>" target="_blank" class="btn btn-primary" data-animation="animated fadeInDown"><?php echo lang('more');?></a><?php } ?>
</div>
</div>
<!-- End of Slide -->
...
<?php if(get('slide_pic4_info')) { ?><p data-animation="animated lightSpeedIn"><?php echo get('slide_pic4_info');?></p><?php } ?>
 <?php if(get('slide_pic4_url')) { ?><a href="<?php echo get('slide_pic4_url');?>" target="_blank" class="btn btn-primary" data-animation="animated fadeInDown"><?php echo lang('more');?></a><?php } ?>
</div>
</div>
<!-- End of Slide -->
...
<?php if(get('slide_pic5_info')) { ?><p data-animation="animated lightSpeedIn"><?php echo get('slide_pic5_info');?></p><?php } ?>
 <?php if(get('slide_pic5_url')) { ?><a href="<?php echo get('slide_pic5_url');?>" target="_blank" class="btn btn-primary" data-animation="animated fadeInDown"><?php echo lang('more');?></a><?php } ?>
</div>
</div>
<!-- End of Slide -->
...
<span class="sr-only">Next</span>
  ...
  <style type="text/css">
.slide-text > h1,.slide-text > p {color:#<?php echo get('slide_text_color');?>;}
.slide-text > a.btn-primary {background:#<?php echo get('slide_input_bg');?>;color:#<?php echo get('slide_input_color');?>;}
  </style>
