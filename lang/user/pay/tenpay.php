...
$_LANG['tenpay'] = '财付通';
$_LANG['tenpay_desc'] = '财付通，在线支付专家，带给您安全快捷的网上付款体验。。（网址：http://www.tenpay.com）';
$_LANG['tenpay_account'] = '商户号';
$_LANG['tenpay_key'] = '初始密钥';
...
$_LANG['tenpay_pay_method'] = '选择接口类型';
$_LANG['tenpay_pay_method_desc'] = '请选择您最后一次跟支付宝签订的协议里面说明的接口类型';
$_LANG['tenpay_pay_method_range'][1] = '使用担保交易接口';
$_LANG['tenpay_pay_method_range'][2] = '使用即时到帐交易接口';
?>