...
<a href="{$base_url}/index.php?case=table&act=add&table=templatetag&tagfrom=category&admin_dir={get('admin_dir')}&site=default" class="btn btn-lightslategray">添加栏目标签</a>
<a href="{$base_url}/index.php?case=table&act=add&table=templatetag&tagfrom=define&admin_dir={get('admin_dir')}&site=default" class="btn btn-steeblue">添加自定义标签</a>
