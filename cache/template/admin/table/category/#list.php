...
<input class="btn btn-primary" type="button" value=" 添加栏目 " onclick="javascript:window.location.href='index.php?case=table&act=add&table=category&admin_dir=<?php echo get('admin_dir');?>'" />
...
<td align="center" class="sort"><span class="hotspot" onmouseover="tooltip.show('填写排序号，<br />数字越小，排序越靠前！');" onmouseout="tooltip.hide();"><?php echo form::input("listorder[$d[$primary_key]]",$d['listorder']);?></span></td>
<td align="center" class="catid">
<?php echo $d['catid'];?>
</td>
<td class="catname"><a style="float:left;" href="<?php echo modify("/act/edit/table/$table/id/$d[$primary_key]");?>"><?php echo $d['catname'];?></a>
<?php if(category::hasson($d['catid'])) { ?>
<?php if($d['level']==0) { ?><a onclick="child(this)" title="点击展开/收起" class="child"><span class="glyphicon glyphicon-indent-left"></span></a><?php } ?>
<?php } ?>
</td>
