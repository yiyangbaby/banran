...
?>
       ...
       echo '<div class="row"><div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right">';
        ...
        echo '<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="标签模板文件存放在&nbsp;template/当前使用模板目录/tpltag/tag_content_*.html!"></span><br/><div style="display:none">';
