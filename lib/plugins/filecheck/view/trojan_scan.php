...
<li><a href="index.php?case=filecheck&act=filecheck&action=file_check&admin_dir=admin&site=default">文件校对</a></li>
<li class="active"><a href="index.php?case=filecheck&act=filecheck&action=trojan_scan&admin_dir=admin&site=default">木马查杀</a></li>
<!-- <li><a href="index.php?case=safe&act=webshell&admin_dir=admin&site=default">后门查杀</a></li>
<li><a href="index.php?case=safe&act=protect&admin_dir=admin&site=default">攻击防护</a></li> -->
</ul>
