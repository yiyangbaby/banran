  ...
  <div id="tagscontent" class="right_box">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table1">
      <tr class="s_out" >
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%"><input type="text" name="keyword" id="keyword" value="{$data['keyword']}" class="form-control" /></td>
      </tr>
      <tr class="s_out" >
        <td width="19%" align="right">完整词</td>
        <td width="1%">&nbsp;</td>
        <td width="70%"><input type="text" name="word" id="word" value="{$data['word']}" class="form-control" /></td>
      </tr>
      <tr class="s_out" >
        ...
        <?php
			...
			?>
            <option value="{$catid}" {if $data['catid']==$catid}selected{/if}>{$catname}</option>
		<?php
		}
			}
			?>
...
<div class="img_upload">
			...
			<dl>
				<div class="blank10"></div>
				<dd style='position:relative;'>
				<input name='twurl[]' type='text' value='{$tmp[1]}'  class="text nonull input" onfocus="if(this.value=='请填写内容链接地址！地址！地址！') {this.value=''}" onblur="if(this.value=='') this.value='请填写内容链接地址！地址！地址！'" /><span class="hotspot" onmouseover="tooltip.show('请填写内容链接地址！地址！地址！');" onmouseout="tooltip.hide();"><img src="{$base_url}/images/admin/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
				</dd>
			</dl>
            <?php
			if($i == 1){
