...
$_LANG['alipay_hb'] = '支付宝花呗分期(默认分12期)';
$_LANG['alipay_desc'] = '蚂蚁金服推出的消费金融产品,支付宝是支付宝公司针对网上交易而特别推出的安全付款服务，其运作的实质是以支付宝为信用中介，在买家确认收到商品前，由支付宝替买卖双方暂时保管货款的一种增值服务。（网址：http://www.alipay.com）';
$_LANG['alipay_account'] = '支付宝帐户';
$_LANG['alipay_key'] = 'MD5密钥';
